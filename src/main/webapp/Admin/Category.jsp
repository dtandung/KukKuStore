...
<!-- Page Title  -->
<title>Category| DashLite Admin Template</title>
<!-- StyleSheets  -->
									...
									<div class="nk-tb-list is-separate is-medium mb-3">
										...
										<c:forEach items="${dsloai }" var="item">
											<div class="nk-tb-item">
												...
												<div class="nk-tb-col">
													<span class="tb-lead"><a href="#">#${item.maLoai}</a></span>
												</div>
												<div class="nk-tb-col tb-col-sm">
													<span class="tb-sub"></span>
												</div>
												<div class="nk-tb-col tb-col-md">
													<span class="tb-sub text-primary">${item.tenLoai}</span>
														...
														<li>
															<div class="drodown mr-n1">
																...
																<div class="dropdown-menu dropdown-menu-right">
																	<form
																		action="AdminCategoryController?ml=${item.maLoai}"
																		method="post">
																		<ul class="link-list-opt no-bdr">
																			<!-- <li><button name ="btn-sua" type="submit"><em class="icon ni ni-eye"></em><span>Chỉnh sửa</span></button></li> -->
																			<li><a
																				href="AdminCategoryController?sua=${item.maLoai}"><em
																					class="icon ni ni-eye"></em><span>Chỉnh sửa</span></a></li>
																			<li><a
																				href="AdminCategoryController?xoa=${item.maLoai}"><em
																					class="icon ni ni-trash"></em><span>Xóa</span></a></li>
																			<c:if test="${sessionScope['checkCat'] == 0 }">
																				<script type="text/javascript">
																					Swal.fire({
																								position : 'center',
																								icon : 'error',
																								title : 'Loại Hàng Này Đang Có Đơn Đặt Hàng!!!',	
