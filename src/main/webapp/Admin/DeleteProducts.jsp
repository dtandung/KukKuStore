                    ...
                    <div class="container-fluid">
                        <div class="nk-content-inner">
                            <div class="nk-content-body">
                                    ...
                                    <form action="AdminEditProductController" enctype="multipart/form-data" method="post">
                                    <div class="nk-block">
                                        <div class="row g-3">
                                            <div class="col-12">
                                                <div class="form-group">
                                                    ...
                                                    <div class="form-control-wrap">
                                                        <input type="text" class="form-control" name="tensanpham" value="${spbean.tenSanPham }">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-mb-6">
                                                <div class="form-group">
                                                    ...
                                                    <div class="form-control-wrap">
                                                        <input type="text" class="form-control" name="gia" value="${spbean.gia }">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-mb-6">
                                                <div class="form-group">
                                                    <label class="form-label" for="sale-price">Ngày Nhập</label>
                                                    <div class="form-control-wrap">
                                                        <input type="text" class="form-control" name="ngaynhap" value="${spbean.ngayNhap }">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-mb-6">
                                                <div class="form-group">
                                                    ...
                                                    <div class="form-control-wrap">
                                                        <input type="text" class="form-control" name="soluong" value="${spbean.soLuong}">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-mb-6">
                                                <div class="form-group">
                                                    ...
                                                    <div class="form-control-wrap">
                                                        <input type="text" class="form-control" name="masanpham" value="${spbean.maSanPham }">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-12">
                                                <div class="form-group">
                                                    ...
                                                    <div class="form-group">
                                                        <div class="form-control-wrap">
                                                            <select class="form-select form-control form-control-lg" data-search="on" name="maloai">
                                            ...
                                            <div class="col-12">
                                                <div class="form-group">
                                                    ...
                                                    <div class="form-control-wrap">
                                                        <input type="text" class="form-control" name="mota" value="${spbean.moTa }">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-12">
                                            ...
                                            <div class="col-12">
                                                <button name="btnEdit" class="btn btn-primary"><em class="icon ni ni-plus"></em><span>Update</span></button>
                                            </div>
                                        </div>
                                </div>
                                </form>
