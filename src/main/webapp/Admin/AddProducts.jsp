                    ...
                    <div class="container-fluid">
                        <div class="nk-content-inner">
                            <div class="nk-content-body">
                                    ...
                                    <form action="AdminAddProductController" enctype="multipart/form-data" method="post">
                                    <div class="nk-block">
                                        <div class="row g-3">
                                            <div class="col-12">
                                            ...
                                            <div class="col-mb-6">
                                                <div class="form-group">
                                                    ...
                                                    <div class="form-control-wrap">
                                                        <input type="text" class="form-control" name="ngaynhap" required>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-mb-6">
                                            ...
                                            <div class="col-12">
                                                <div class="form-group">
                                                    ...
                                                    <div class="form-group">
                                                        <div class="form-control-wrap">
                                                            <select class="form-select form-control form-control-lg" data-search="on" name="maloai" required>
                                            ...
                                            <div class="col-12">
                                                <div class="file-upload">
                                                    <div class="image-upload-wrap">
                                                        <input class="file-upload-input" type='file' onchange="readURL(this);" accept="image/*" name="anh" required/>
                                                        <div class="drag-text">
                                            ...
                                            <div class="col-12">
                                                <button name="btnAdd" class="btn btn-primary"><em class="icon ni ni-plus"></em><span>Add New</span></button>
                                            </div>
                                             <div class="col-12">
                                                <a  href="AdminProductController?ql" class="btn btn-primary"><em class="icon ni ni-chevron-left"></em><span>Quay Lại</span></a>
                                            </div>
                                        </div>
                                </div>
                                </form>
