...
<!-- Page Title  -->
<title>Remittance List Detail</title>
<!-- StyleSheets  -->
						...
						<div class="nk-content-inner">
							<div class="nk-content-body">
											...
											<c:forEach items="${dsctdh }" var="item">
												<tr class="tb-tnx-item">
													...
													<td class="text-center">
														...
														<div ><a href="AdminOrderDetailController?mct=${item.maChiTietHD }&mhd=${item.maHoaDon }&btndetail=${1}" class="btn btn-icon btn-trigger btn-tooltip"														
															title="Confirm Order" ><em class="icon ni ni-check-circle-cut"></em></a></div>
													</c:if> --%>
													</td>
												</tr>
											</c:forEach>
								...
								<div class="col-12 pt-3">
									<form action="AdminRemittanceListController" method="post">
