...
<!-- Page Title  -->
<title>Remittance List | DashLite Admin Template</title>
<!-- StyleSheets  -->
								...
								<div class="nk-block-head nk-block-head-sm">
									<div class="nk-block-between">
										<div class="nk-block-head-content">
											<h3 class="nk-block-title page-title">Remittance List</h3>
										</div>
								...
								<div class="nk-block">
									<div class="nk-tb-list is-separate is-medium mb-3">
										<div class="nk-tb-item nk-tb-head">
											...
											<div class="nk-tb-col">
												<span class="d-none d-mb-block">Status</span>
											</div>
											...
											<div class="nk-tb-item">
												...
												<c:choose>
													<c:when test="${item.daMua == true }">
														<div class="nk-tb-col">
															<span class="dot bg-success d-mb-none"></span> <span
													...
													<c:otherwise>
														<div class="nk-tb-col">
															<span class="dot bg-warning d-mb-none"></span> <span
																class="badge badge-sm badge-dot has-bg badge-warning d-none d-mb-inline-flex">Chưa Xác Nhận</span>
														</div>
													</c:otherwise>
												</c:choose>
												...
												<div class="nk-tb-col tb-col-sm">
													<span class="tb-sub">${item.hoTen }</span>
												</div>
												<!--                  <div class="nk-tb-col tb-col-md">
                                                <span class="tb-sub text-primary">3 Items</span>
                                            </div> -->
												<div class="nk-tb-col">
													<span class="tb-lead">${item.thanhTien } vnđ</span>
												</div>
												<div class="nk-tb-col nk-tb-col-tools">
													<ul class="nk-tb-actions gx-1">
														<%-- <li class="nk-tb-action-hidden"><a href="AdminOrderController?mhd=${item.maHoaDon}"
															class="btn btn-icon btn-trigger btn-tooltip"
															title="Confirm Order" ><em class="icon ni ni-check-circle-cut"></em></a></li> --%>
															
														<li class="nk-tb-action-hidden"><a href="AdminRemittanceListController?mcthd=${item.maHoaDon}"
															class="btn btn-icon btn-trigger btn-tooltip"
															title="View Order" > <em
