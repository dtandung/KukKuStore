                    ...
                    <div class="container-fluid">
                        <div class="nk-content-inner">
                            <div class="nk-content-body">
                                    ...
                                    <form action="AdminEditCategoryController" method="post">
                                    <div class="nk-block">
                                        <div class="row g-3">
                                            <div class="col-12">
                                                <div class="form-group">
                                                    ...
                                                    <div class="form-control-wrap">
                                                        <input type="text" class="form-control" id="product-title" name = "txtml" value="${loaibean.getMaLoai() }" readonly>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-12">
                                                <div class="form-group">
                                                    ...
                                                    <div class="form-control-wrap">
                                                        <input type="text" class="form-control" id="product-title" name ="txttl" value="${loaibean.getTenLoai() }">
                                                        
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-12">
                                                <button name="btnEdit" type="submit" class="btn btn-primary"><em class="icon ni ni-plus"></em><span>Cập Nhật</span></button>
                                            </div>
                                            <div class="col-12">
