                                    ...
                                    <div class="nk-block-head">
                                        <div class="nk-block-head-content">
                                            ...
                                            <div class="nk-block-des">
                                                <p>Add new information category.</p>
                                            </div>
                                        </div>
                                    </div><!-- .nk-block-head -->
                                    <form action="AdminAddCategoryController" method="post">
                                    <div class="nk-block">
                                        <div class="row g-3">
                                            <div class="col-12">
                                                <div class="form-group">
                                                    ...
                                                    <div class="form-control-wrap">
                                                        <input type="text" class="form-control" id="product-title" name="ml" required>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-12">
                                                <div class="form-group">
                                                    ...
                                                    <div class="form-control-wrap">
                                                        <input type="text" class="form-control" id="product-title" name="tl" required>
                                                    </div>
                                                </div>
                                            </div>
                                            
                                            <div class="col-12">
                                                <button name="btnAdd" type="submit" class="btn btn-primary"><em class="icon ni ni-plus"></em><span>Thêm mới</span></button>
                                            </div>
                                            <div class="col-12">
