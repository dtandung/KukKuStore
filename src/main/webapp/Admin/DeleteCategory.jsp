                            ...
                            <div class="nk-content-body">
                                    <div class="nk-block-head">
                                        <div class="nk-block-head-content">
                                            <h5 class="nk-block-title">Update Category</h5>
                                            <div class="nk-block-des">
                                                <p>Update information category.</p>
                                            </div>
                                        </div>
                                    </div><!-- .nk-block-head -->
                                    <form action="AdminDeleteCategoryController?ml=${dsloai.getMaLoai() }" method="post">
                                    <div class="nk-block">
                                        <div class="row g-3">
                                            <div class="col-12">
                                                <div class="form-group">
                                                    <label class="form-label" for="product-title">Id</label>
                                                    <div class="form-control-wrap">
                                                        <input type="text" class="form-control" id="product-title" name = "txtml" value="${dsloai.getMaLoai() }" readonly>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-12">
                                                <div class="form-group">
                                                    ...
                                                    <div class="form-control-wrap">
                                                        <input type="text" class="form-control" id="product-title" name =" txttl" value="${dsloai.getTenLoai() }" readonly>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-12">
                                                <button name="btnDel" type="submit" class="btn btn-primary"><em class="icon ni ni-plus"></em><span>Xoá</span></button>
                                            </div>
                                            <div class="col-12">
                                                <button formaction="AdminCategoryController" formmethod="post" class="btn btn-primary"><em class="icon ni ni-chevron-left"></em><span>Quay Lại</span></button>
                                            </div>
                                        </div>
                                </div>
                                </form>
