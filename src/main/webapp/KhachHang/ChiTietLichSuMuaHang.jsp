...
<body class="animsition">
	...
	<form class="bg0 p-t-75 p-b-85">
		<div class="container">
			<div class="row">
				<div class="m-lr-auto m-b-50" style="min-width: 1200px;">
					<div class="m-l-25 m-r--38 m-lr-0-xl">
						<button type="submit" formaction="LichSuMuaHangController"
							formmethod="post" style="height: 45px"
							class=" m-tb-10 wrap-num-product btn-num-product-up cl8 hov-btn3 trans-04 flex-c-m"
						...
						<div class="wrap-table-shopping-cart">
							<table class="table-shopping-cart">
								...
								<tr class="table_head">
									...
									<th class=" text-center">Mã CTHĐ</th>
									<th class=" text-center">Ảnh</th>
									<th class=" text-center">Tên Sản Phẩm</th>
									<th class=" text-center" style="padding-right: 0px">Giá</th>
									<th class=" text-center" style="padding-right: 0px">Số
										Lượng</th>
									<th class=" text-center">Ngày Mua</th>
									<th class=" text-center">Thành Tiền</th>
									<th class="text-center">Trạng Thái</th>
								</tr>
								<c:forEach var="item" items="${ctlsmh }">
									<tr class="table_row" style="height: 130px">
										<td class="text-center" style="padding-bottom: 20px">${item.maHoaDon}</td>

										<td class=" text-center">${item.maChiTietHD }</td>
										<td class=" text-center"><img alt="" src="${item.anh }"
											style="object-fit: contain"
											width="70"></td>
										<td class=" text-center">${item.tenSanPham}</td>
										<td class=" text-center" style="padding-right: 0px">${item.gia }</td>
										...
										<c:choose>
											<c:when test="${item.daMua == true }">
												<td class="text-center" style="padding-right: 0px">Đã
													Thanh Toán</td>
											</c:when>
											<c:otherwise>
												<td class="text-center" style="padding-right: 0px">Chưa
													Thanh Toán</td>
											</c:otherwise>
										</c:choose>
									</tr>
