...
<body class="animsition">
	...
	<div class="container">
		<div class="bread-crumb flex-w p-l-25 p-r-15 p-t-30 p-lr-0-lg">
			...
			</a> <a href="SanPhamController" class="stext-109 cl8 hov-cl1 trans-04">
				Shop <i class="fa fa-angle-right m-l-9 m-r-10" aria-hidden="true"></i>
			</a> <span class="stext-109 cl4"> ${item.tenSanPham} </span>
		</div>
	</div>
			...
			<div class="row">
					...
					<div class="p-l-25 p-r-30 p-lr-0-lg">
						<div class="wrap-slick3 flex-sb flex-w">
							...
							<div class="slick3 gallery-lb">
								<div class="item-slick3" data-thumb="${item.anh }">
									<div class="wrap-pic-w pos-relative">
										<img src="${item.anh }" alt="IMG-PRODUCT"> <a
											class="flex-c-m size-108 how-pos1 bor0 fs-16 cl10 bg0 hov-btn3 trans-04"
											href="${item.anh }"> <i class="fa fa-expand"></i>
										</a>
									</div>
								</div>
							</div>
				...
				<div class="col-md-6 col-lg-5 p-b-30">
					<div class="p-r-50 p-t-5 p-lr-0-lg">
						...
						<span class="mtext-106 cl2"> ${item.gia } vnđ </span>

						<p class="stext-102 cl3 p-t-23">${item.moTa }</p>
						...
						<div class="p-t-33">
							...
							<form
								action="GioHangController?msp=${item.maSanPham}&tsp=${item.tenSanPham }&gia=${item.gia }&img=${item.anh}"
								method="post">
								<div class="flex-w flex-r-m p-b-10">
									<div class="size-204 flex-w flex-m respon6-next">
										...
										<div class="d-flex">
											<div class="wrap-num-product flex-w m-r-20 m-tb-10">
												...
												<input min="0" class="mtext-104 cl3 txt-center num-product"
													type="number" name="txtsl" value="1">
										...
										<div class="d-flex ">
											<button type="submit" formaction="SanPhamController"
												formmethod="post"
												class="mr-3 mt-3 flex-c-m stext-101 cl0 size-101 bg1 bor1 hov-btn1 p-lr-15 trans-04 js-addcart-detail"
												name="addtocart">Back To Shop</button>

											<button type="submit"
												class=" mt-3 flex-c-m stext-101 cl0 size-101 bg1 bor1 hov-btn1 p-lr-15 trans-04 js-addcart-detail"
					...
					<div class="tab-content p-t-43">
						...
						<div class="tab-pane fade show active" id="description"
							...
							<div class="how-pos2 p-lr-15-md">
								<p class="stext-102 cl6">${item.moTa }</p>
							</div>
						</div>
									...
									<div class="p-b-30 m-lr-15-sm">
										...
										<div class="flex-w flex-t p-b-68">
											<div class="wrap-pic-s size-109 bor0 of-hidden m-r-18 m-t-6">
												<img src="KhachHang/images/avatar-01.jpg" alt="AVATAR">
											</div>
		...
		<div class="container">
			<div class="bg0 p-t-60 p-b-30 p-lr-15-lg how-pos3-parent">
				<button class="how-pos3 hov3 trans-04 js-hide-modal1">
					<img src="KhachHang/images/icons/icon-close.png" alt="CLOSE">
				</button>
							...
							<div class="wrap-slick3 flex-sb flex-w">
								...
								<div class="slick3 gallery-lb">
									<div class="item-slick3"
										data-thumb="KhachHang/images/product-detail-01.jpg">
										<div class="wrap-pic-w pos-relative">
											<img src="KhachHang/images/product-detail-01.jpg"
												alt="IMG-PRODUCT"> <a
												class="flex-c-m size-108 how-pos1 bor0 fs-16 cl10 bg0 hov-btn3 trans-04"
												href="KhachHang/images/product-detail-01.jpg"> <i
									...
									<div class="item-slick3"
										data-thumb="KhachHang/images/product-detail-02.jpg">
										<div class="wrap-pic-w pos-relative">
											<img src="KhachHang/images/product-detail-02.jpg"
												alt="IMG-PRODUCT"> <a
												class="flex-c-m size-108 how-pos1 bor0 fs-16 cl10 bg0 hov-btn3 trans-04"
												href="KhachHang/images/product-detail-02.jpg"> <i
												class="fa fa-expand"></i>
											</a>
										</div>
									</div>
									...
									<div class="item-slick3"
										data-thumb="KhachHang/images/product-detail-03.jpg">
										<div class="wrap-pic-w pos-relative">
											<img src="KhachHang/images/product-detail-03.jpg"
												alt="IMG-PRODUCT"> <a
												class="flex-c-m size-108 how-pos1 bor0 fs-16 cl10 bg0 hov-btn3 trans-04"
												href="KhachHang/images/product-detail-03.jpg"> <i
												class="fa fa-expand"></i>
											</a>
										</div>
									</div>
	...
	<!--===============================================================================================-->
	<script src="KhachHang/vendor/sweetalert/sweetalert.min.js"></script>
	<script>
