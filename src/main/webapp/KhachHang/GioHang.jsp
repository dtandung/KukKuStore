				...
				<div class="col-lg-10 col-xl-7 m-lr-auto m-b-50">
					<div class="m-l-25 m-r--38 m-lr-0-xl">
						<div class="wrap-table-shopping-cart">
							<table class="table-shopping-cart">
								<tr class="table_head">
									...
									<th class="column-4 text-center"></th>
									<th class="column-5 text-center">Total</th>
									<th class="column-1 text-center"></th>
								</tr>
								<c:forEach items="${ sessionScope.gio.getAll() }" var="item">
									<tr class="table_row">
										<td class="column-1 text-align-center"><input type="checkbox"
											name="check" value="${ item.maSanPham }"
											class="form-check-input" id="exampleCheck1"></td>

										<td class="column-2 text-align-center">
											<div class="how-itemcart1">
												<img src="${item.anh }" alt="IMG">
											</div>
										</td>
										<td class="column-2 " >${item.tenSanPham }</td>
										<td class="column-4 text-center">${item.gia }</td>
										<td class="column-4 d-flex text-center"
											style="padding-top: 60px; align-items: center; padding-left: 25px">
											<div class="wrap-num-product flex-w m-l-auto m-r-0" >
												...
												<input class="mtext-104 cl3 txt-center num-product"
													type="number" name="t${item.maSanPham }"
													value="${item.soLuong }">
										...
										<td class="column-4 text-center"
											style=" padding-right: 25px; padding-bottom: 20px;"><button
												value="${item.maSanPham}" type="submit"
												style="max-width: 45px; max-height: 45px"
												class=" m-tb-10 wrap-num-product cl8 hov-btn3 trans-04 flex-c-m"
												name="update-quantity">
												<i class="fa-solid fa-check"></i>
											</button></td>
										<td class="column-5 text-align-center"
											style="padding-right: 25px;padding-bottom: 20px;">${item.getThanhTien()}vnđ</td>
										<td
											class="column-1 d-flex justify-content-center align-items-center text-align-center"
											style="padding-left: 15px; width: 0px">
											<button value="${item.maSanPham }" name="delete-one"
												type="submit">
						...
						<div
							...
							<button formaction="SanPhamController" formmethod="post"
								class="flex-c-m stext-101 cl2 size-118 bg8 bor13 hov-btn3 p-lr-15 trans-04 pointer m-tb-5">
								Back To Shop</button>
							<c:if test="${ sessionScope.gio.getAll() == null }">
								<span>No Item In Cart</span>
							</c:if>
							<c:if test="${ sessionScope.gio.getAll().size() >0 }">
								<button type="submit" name="delete-check"
									class="flex-c-m stext-101 cl2 size-119 bg8 bor13 hov-btn3 p-lr-15 trans-04 pointer m-tb-10">
									Delete Check</button>

								<button type="submit" name="clear-cart"
									class="flex-c-m stext-101 cl2 size-119 bg8 bor13 hov-btn3 p-lr-15 trans-04 pointer m-tb-10">
									Clear Cart</button>
							</c:if>
						</div>
				...
				<c:if test="${ sessionScope.gio.getAll().size() >0 }">
					<div class="col-sm-10 col-lg-7 col-xl-5 m-lr-auto m-b-50">
						<div
									...
									<div class="p-t-15">
										...
										<div class="bor8 bg0 m-b-12">
											<input class="stext-111 cl8 plh3 size-111 p-lr-15"
												type="text" name="state" placeholder="Thành Phố/Tỉnh">
										</div>

										<div class="bor8 bg0 m-b-22">
											<input class="stext-111 cl8 plh3 size-111 p-lr-15"
												type="text" name="postcode" placeholder="Địa Chỉ">
										</div>
							...
							<button formaction="HienThiGioController/confirm"
								formmethod="post"
