					...
					<div class="m-l-25 m-r--38 m-lr-0-xl">
						<div class="wrap-table-shopping-cart">
							<table class="table-shopping-cart">
								<tr class="table_head">
									<th class="column-3 text-center">Mã Hoá Đơn</th>
									<th class="column-3 text-center">Họ Tên</th>
									<th class="column-4 text-center">Ngày Mua</th>
									<th class="column-5 text-center" style="padding-right: 0px">Thành
										Tiền</th>
									<th class="column-5 text-center" style="padding-right: 0px">Trạng
										Thái</th>
									<th class="column-3 text-center">Chi Tiết</th>
								</tr>
									...
									<tr class="table_row">
										...
										<c:choose>
											<c:when test="${item.daMua == true }">
												<td class="text-center column-5 " style="padding-right: 0px">Đã
													Thanh Toán</td>
											</c:when>
											<c:otherwise>
												<td class="text-center column-5" style="padding-right: 0px">Chưa
													Thanh Toán</td>
											</c:otherwise>
										</c:choose>
