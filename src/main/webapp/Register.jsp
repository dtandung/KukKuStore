	...
	<div class="limiter">
		<div class="container-login100">
			<div class="wrap-login100">
				...
				<form action="CustomerRegisterController" method="post" class="login100-form validate-form">
					<span class="login100-form-title">
						Customer Register
					</span>
					
					<div class="wrap-input100 validate-input" data-validate = "Valid fullname is required: abc">
					...
					<div class="wrap-input100 validate-input" data-validate = "Valid address is required: ab,123">
					...
					<div class="wrap-input100 validate-input" data-validate = "Valid phonenumber is required: 0946.xxx.xxx">
